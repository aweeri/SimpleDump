...
namespace satdump
{
    LoadingScreenSink::LoadingScreenSink()
    {
        ...
        title = loader_constant ? satdump::loader_constant_title : "SimpleDump";
        slogan = loader_constant ? satdump::loader_constant_slogan : "Simple General Purpose Satellite Data Processor";
        if (loader_constant)
